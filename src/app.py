...
activities = {
    ...
    "Basketball Club": {
        "description": "Build skills and play friendly basketball games",
    ...
    "Drama Club": {
        "description": "Learn acting, stagecraft, and put on school performances",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["elijah@mergington.edu", "amelia@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking and critical thinking for competitions",
...
def unregister_participant(activity_name: str, participant_email: str):
